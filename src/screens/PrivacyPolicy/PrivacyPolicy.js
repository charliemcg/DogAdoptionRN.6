  ...
  render() {
    return (
      <SafeAreaView style={styles.parent}>
        <ScrollView>
          <MarkdownView style={styles.content}>
            ## Privacy Policy{'\n\n'}Violent Hobo Enterprises built the Dog
            Adoption app as a Freemium app. This SERVICE is provided by Violent
            Hobo Enterprises at no cost and is intended for use as is. {'\n\n'}
            This page is used to inform visitors regarding our policies with the
            collection, use, and disclosure of Personal Information if anyone
            decided to use our Service. {'\n\n'}If you choose to use our
            Service, then you agree to the collection and use of information in
            relation to this policy. The Personal Information that we collect is
            ...
            our Terms and Conditions, which is accessible at Dog Adoption unless
            otherwise defined in this Privacy Policy. {'\n\n'}**Information
            Collection and Use** {'\n\n'}For a better experience, while using
            our Service, we may require you to provide us with certain
            personally identifiable information. The information that we request
            ...
            **Children’s Privacy** {'\n\n'}These Services do not address anyone
            ...
            do not hesitate to contact us at support@dogadoption.com.
          </MarkdownView>
        </ScrollView>
      </SafeAreaView>
    );
